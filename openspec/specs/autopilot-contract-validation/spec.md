# autopilot-contract-validation Specification

## Purpose

Define deterministic guards that keep OpenSpec Autopilot public contracts, validation commands, evidence freshness, and manual plugin bundle checks synchronized across reusable instructions, plugin surfaces, TypeScript helpers, README guidance, and archive/release gates.
## Requirements
