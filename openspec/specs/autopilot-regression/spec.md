# autopilot-regression Specification

## Purpose
Define durable evidence expectations for OpenSpec Autopilot live regressions, including explicit command smoke, scenario coverage, follow-up routing, safety stops, and report contents.
