# autopilot-ledger-validation Specification

## Purpose

Define task-type-specific Autopilot ledger evidence gates for reproduction, deterministic tooling/config validation, performance evidence, and protocol compatibility proof before review or implementation advances.
