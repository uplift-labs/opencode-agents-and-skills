# autopilot-control-output Specification

## Purpose

Define the compact, reason-coded Autopilot control-plane output that lets agents distinguish no-progress, blocked, MR-wait, failed, and advanced states without re-reading full ledgers.
