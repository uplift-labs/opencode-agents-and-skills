...
- [x] Integrate workflow routing outcomes into retrospective templates and evidence-pack generated sections.
...
- [x] `npm run openspec:retro-gate -- require-openspec-change-retro-gate`.
